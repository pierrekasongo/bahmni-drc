...
Bahmni.Registration.Constants = {
  ...
  IL_URL: "http://il.anicns.cd:5001/",
  IL_USER: "med_appro_user",
  IL_PWD: "v2xvUzFoXPkMCLTvmcZgRwUQ",
};

Bahmni.Registration.Constants.Errors = {
  manageIdentifierSequencePrivilege:
    "You don't have the privilege to create a patient with the given ID.",
};
